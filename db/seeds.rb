...
Invite.create(client_id: 1, coach_activity_id:5)
Invite.create(client_id: 1, coach_activity_id:5)
Invite.create(client_id: 2, coach_activity_id:5)
...
# CLARA'S APPTS
appt = Appointment.create!(coach_activity_id:rand(5)+1, child_id: 3, location_id: rand(3)+1, start: Faker::Time.between(5.days.ago, Date.today+20, :morning), end: Faker::Time.between(seed_time, seed_time+1.hours, :morning))
appt = Appointment.create!(coach_activity_id:rand(5)+1, child_id: 3, location_id: rand(3)+1, start: Faker::Time.between(5.days.ago, Date.today+20, :morning), end: Faker::Time.between(seed_time, seed_time+1.hours, :morning))
appt = Appointment.create!(coach_activity_id:rand(5)+1, child_id: 3, location_id: rand(3)+1, start: Faker::Time.between(5.days.ago, Date.today+20, :morning), end: Faker::Time.between(seed_time, seed_time+1.hours, :morning))
appt = Appointment.create!(coach_activity_id:rand(5)+1, child_id: 3, location_id: rand(3)+1, start: Faker::Time.between(5.days.ago, Date.today+20, :morning), end: Faker::Time.between(seed_time, seed_time+1.hours, :morning))
appt = Appointment.create!(coach_activity_id:rand(5)+1, child_id: 3, location_id: rand(3)+1, start: Faker::Time.between(5.days.ago, Date.today+20, :morning), end: Faker::Time.between(seed_time, seed_time+1.hours, :morning))
